GyanSchool::Application.routes.draw do
  ...
  match 'section/:section_id/create_exam' => 'home#section_exams_create' ,:via => :post
  match 'section/:section_id/exams' => 'home#section_exams_index'
  match 'section/:section_id/exams/:exam_id/subjects' => 'home#section_exam_subjects'
  match 'section/:section_id/exams/:exam_id/subjects/:course_id/show' => 'home#section_exam_subject_marks'
